...
if (isset($_POST['tambah'])) {
    ...
    if (empty($nama) || empty($alamat) || empty($no_hp) || empty($id_poli) || empty($username) || empty($password)) {
        ...
        if (mysqli_query($koneksi, $query)) {
            ...
            echo "<script>location='index.php?halaman=keloladokter';</script>";
        } else {
...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<a href='index.php?halaman=keloladokter&hapus=" . $row['id'] . "' onclick='return confirm(\"Yakin ingin menghapus data ini?\")' class='btn btn-danger btn-sm'>Hapus</a>";
            echo "</td>";
            echo "</tr>";
