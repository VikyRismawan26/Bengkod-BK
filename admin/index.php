    ...
    <nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li>
						<a href="index.php?halaman=keloladokter"><i class="fa fa-cube"></i> Kelola Dokter</a>
					</li>
					<li>
						<a href="index.php?halaman=kelolapasien"><i class="fa fa-question-circle"></i>Kelola Pasien Pasien</a>
					</li>
					<li>
						<a href="index.php?halaman=kelolapoli"><i class="fa fa-question-circle"></i>Kelola Poli</a>
					</li>
					<li>
			...
			<div id="page-inner">
				<?php	
					if(isset($_GET["halaman"])){
						...
						}elseif($_GET["halaman"] == "kelolapoli"){
